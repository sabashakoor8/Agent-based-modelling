...
to make_butterfiles_move
  ask butterflies [
    ;set color blue
    ;let seen [false]
   ; let hit [false]
   ; ask peoples in-cone per_vis_rad per_vis_ang [
     ; set color green
   ;   set seen true
   ; ]
  ...
  ;  let can_smell_food_function 30
...
"pen-1" 1.0 0 -7500403 true "" "plot count butterflies"
"pen-2" 1.0 0 -2674135 true "" "plot count people"
"pen-3" 1.0 0 -955883 true "" "plot count venom"
